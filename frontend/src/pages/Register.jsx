        ...
        <div className="bg-slate-950 min-h-screen w-screen font-mono">
           ...
           <div className="w-screen mt-36  flex justify-center items-center">
                <div className=" border border-sky-700 hover:shadow-md transition-all duration-700 p-4 sm:p-7 rounded-3xl backdrop-blur-lg">
                    <div className="text-6xl mb-2 font-bold sm:text-7xl text-sky-500 font-mono w-full text-center">
                        Register
                    </div>
                    <div className=" flex flex-col justify-center items-center gap-4">
                        ...
                        <div>
                            <button onClick={handleregister} className="bg-sky-400 w-72 sm:w-96 p-1 rounded-lg hover:bg-sky-300 font-semibold text-xl">Register</button>
                        </div>
